...
@IBDesignable class UIXRangeSliderOld: UIControl
{
    //Config
    ...
    var inactiveBarColor:UIColor = UIColor.lightGrayColor() //
        {
        didSet {
            self.inactiveBarView.backgroundColor = inactiveBarColor
        }
    }
    
    var activeBarColor:UIColor = UIColor.blueColor() //
        {
        didSet {
            self.activeBarView.backgroundColor = activeBarColor
        }
    }
    
    var middleThumbColor:UIColor = UIColor.blueColor() //
        {
        didSet {
            self.middleThumbView.backgroundColor = middleThumbColor
        }
    }
    ...
    */
    ...
    func assignColors()
    {
        ...
        if (self.enabled)
        {
            self.inactiveBarView.backgroundColor = self.inactiveBarColor
            self.activeBarView.backgroundColor = self.activeBarColor
            self.middleThumbView.backgroundColor = self.middleThumbColor
        }
        else
        {
            self.inactiveBarView.backgroundColor = UIColor.grayColor()
            self.activeBarView.backgroundColor = UIColor.grayColor()
            self.middleThumbView.backgroundColor = UIColor.grayColor()
        }
